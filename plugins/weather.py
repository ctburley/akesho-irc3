    ...
    def weather(self, mask, channel, args):
        ...
        with shelve.open('data/weather') as pstore:
            ...
            if where:
                ...
                output="{nick}: Right now, {csummary}, {ftemp:.0f}F/{ctemp:.0f}C with a high of {fhigh:.0f}/{chigh:.0f} and low of {flow:.0f}/{clow:.0f}. Humidity is {humidity:.0%}, and the wind is {mwind:.0f}MPH/{kwind:.0f}KPH {wbearing}. Then, {hsummary} - {location} - https://darksky.net/poweredby/"
